                    ...
                    <div className="columns is-gapless">
                        <div className="column ">
                            <div className="post-box box-1 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-weight-semibold">
                                <p className="is-flex is-justify-content-center is-size-7 is-size-6-desktop is-flex is-align-items-center has-text-grey"><i className="fa-solid fa-seedling is-size-5"></i><span className="ml-1 mb-1 is-size-5 is-size-4-desktop has-text-dark">{props.post.plantName}</span></p>
                        ...
                        <div className="column">
                            ...
                            <p className="is-flex is-justify-content-center is-size-7 is-size-6-desktop has-text-grey"><span className="ml-1 has-text-weight-semibold has-text-dark">{props.post.description}</span></p>
                            </div>
                        </div>
                        <div className="column">
                            <div className="post-box box-3 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-dark is-size-7 is-size-6-desktop ">
                                
                                    { !addressRequested && <div><span className="is-flex is-justify-content-center ">{props.post.wasRequested ? "Has been requested " + props.post.numberOfRequests + " time" + (props.post.numberOfRequests === 1 ? "" : "s") : "Be the first to request!"}</span>
