                    ...
                    <div className="columns is-3">
                        ...
                        <div className="column">
                            <div className="box box-2 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-dark is-size-6 is-size-5-desktop has-text-weight-semibold">
                                <span className="is-flex is-justify-content-center ">{props.post.wasRequested ? "Has been requested " + props.post.numberOfRequests + " time" + (props.post.numberOfRequests === 1 ? "" : "s") : "This hasn't been requested yet"}</span>
                                <span className="is-flex is-justify-content-center ">{props.post.wasRequested ? "Was first requested at " + props.post.firstRequestTime : "Be the first to request!"}</span>
                            </div>
                        </div>
                        <div className="column">
